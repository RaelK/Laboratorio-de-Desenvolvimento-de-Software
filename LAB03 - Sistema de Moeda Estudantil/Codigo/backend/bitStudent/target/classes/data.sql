...
INSERT INTO professor (id, nome, email, cpf, login, senha, departamento, saldo_moedas) VALUES (1, 'Prof. Teste', 'prof@test.com', '11122233344', 'profteste', 'senha', 'CIÊNCIAS', 100);

INSERT INTO aluno (id, nome, email, cpf, login, senha, rg, endereco, curso, saldo_moedas, instituicao_id) VALUES (1, 'Aluno Teste', 'aluno@test.com', '55566677788', 'alunoteste', 'senha', '12345678', 'Rua Exemplo, 100', 'Engenharia', 10, 1);

INSERT INTO empresa_parceira (id, nome, email, login, senha) VALUES (1, 'Parceira Teste', 'parceira@test.com', 'parceirateste', 'senha');
