...
export default function StudentStatement() {
  ...
  return (
    <>
      <div
        className="bg-full brightness-75"
        style={{ backgroundImage: "url('/images/extrato.jpg')" }}
      ></div>
      ...
      <div className="flex justify-center items-center min-h-screen px-4 relative z-10">
        <div className="w-full max-w-2xl bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200">
              ...
              <ul className="space-y-3">
                {transacoes.map((t) => (
                  ...
                  >
                    ...
                    <div
                      className={`font-bold ${t.tipo === "ENVIO"
                        ? "text-green-600"
                        : "text-red-600"
                        }`}
                    >
          ...
          <div className="px-6 py-6 flex flex-col items-center gap-3">
            ...
            <Link to="/alunos/vantagens" className="btn w-full max-w-xs text-center">
              Voltar à loja
            </Link>
          </div>
        </div>
