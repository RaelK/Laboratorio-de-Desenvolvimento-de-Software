...
export default function ProfessorProfile() {
    ...
    return (
        <>
            {/* Fundo quadro FULL HD */}
            <div className="chalkboard"></div>

            {/* Conteúdo principal centralizado */}
            <div className="relative z-10 max-w-5xl mx-auto grid md:grid-cols-2 gap-6 px-6 py-10">
                {/* Card principal */}
                <div className="card">
                    ...
                    <div className="mt-6 flex gap-3 flex-wrap">
                        <Link to="/professores/painel" className="btn btn-primary">
                ...
                <div className="card">
                    ...
                    <p className="text-white/70 text-sm mb-3">
                        Este professor está habilitado a distribuir até 1.000 moedas por semestre,
                        acumulando o saldo não utilizado.
                    </p>
